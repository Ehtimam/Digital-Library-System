                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_POST['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM book WHERE CONCAT(ind,id,name,writer,pdf) LIKE '%$filtervalues%' ";
                                        ...
                                        if(mysqli_num_rows($query_run) > 0)
                                        {
                                            foreach($query_run as $items)
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="file" name="pdf" value="<?= $items['pdf']; ?>" /></td>
